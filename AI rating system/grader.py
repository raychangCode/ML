...
# Epoch 40 : Official: train error = 0.03601575689364097, validation error = 0.26730444569499157
# Epoch 50 : Official: train error = 0.024760832864378166, validation error = 0.26617895329206526
# Epoch 60 : Official: train error = 0.018851997749015192, validation error = 0.25998874507597075
# Epoch 70 : Official: train error = 0.014631401238041642, validation error = 0.26139561057962857
############################################################
...
def test4a2():
    ...
    weights = submission.learnPredictor(trainExamples, validationExamples, featureExtractor, numEpochs=70, alpha=0.01)
...
# TODO: extractWordFeatures took 11 sec for task 4a-2
# TODO: extractCharacterFeatures took 21 sec for task 4a-2
############################################################
